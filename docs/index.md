...
- <span style="display:inline-block;padding:.1em .6em;border-radius:1em;font-size:.82em;font-weight:600;background:#ffebe9;color:#7a271a;white-space:nowrap">Needs review</span> `CHANGED` - [fqhc_cms_center](https://www.cms.gov/medicare/payment/prospective-payment-systems/federally-qualified-health-centers-fqhc-center) _(FQHC)_
  ...
  - **Seen before:** flagged 2 times in the last 60 days. If it keeps repeating with nothing behind it, tighten or retire the watchlist entry.
...
## Sources changed in the last 60 days (5)
...
- [Obstetrics](#obstetrics-obstetrics) - 1 source
...
#### <span style="display:inline-block;padding:.1em .6em;border-radius:1em;font-size:.82em;font-weight:600;background:#eef1f5;color:#3f4c5a;white-space:nowrap">Not yet checked</span> ob_cpsp_manual_docs - `not_yet_checked`

<p style="margin:.2em 0 .2em 2em"><a href="https://mcweb.apps.prd.cammis.medi-cal.ca.gov/publications/manual?community=obstetrics">Open the source</a> - not in the last run</p>

<p style="margin:.2em 0 .2em 2em"><b>Why:</b> This entry is in the watchlist, but the last run did not cover it.</p>

<details style="margin:.3em 0 1.1em 2em">
<summary>Details: exactly what is checked here, how, and its caveats</summary>
<ul style="line-height:1.6;margin:.5em 0;padding-left:1.4em">
<li><b>URL watched:</b> <a href="https://mcweb.apps.prd.cammis.medi-cal.ca.gov/publications/manual?community=obstetrics">https://mcweb.apps.prd.cammis.medi-cal.ca.gov/publications/manual?community=obstetrics</a></li>
<li><b>How:</b> The portal's JSON list endpoint is queried; every document it lists is watched individually (PDF text hash plus the portal's revision date). New documents are auto-discovered and removals are flagged. Checked by the weekly script run (Mondays 14:00 UTC, GitHub Actions).</li>
<li><b>Status:</b> not_yet_checked - This entry is in the watchlist, but the last run did not cover it.</li>
<li><b>Last checked:</b> not covered by the last run</li>
<li><b>Last recorded change:</b> none since the change log began</li>
...
#### <span style="display:inline-block;padding:.1em .6em;border-radius:1em;font-size:.82em;font-weight:600;background:#eef1f5;color:#3f4c5a;white-space:nowrap">Not yet checked</span> rev_obstetrics_manuals - `not_yet_checked`
...
<li style="color:#5b2d86;font-weight:600">ob_cpsp_manual_docs - <a href="https://mcweb.apps.prd.cammis.medi-cal.ca.gov/publications/manual?community=obstetrics" style="color:#5b2d86">https://mcweb.apps.prd.cammis.medi-cal.ca.gov/publications/manual?community=obstetrics</a></li>
